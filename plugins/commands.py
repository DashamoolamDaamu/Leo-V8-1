...
from utils import get_settings, get_size, is_subscribed, save_group_settings, temp, create_invite_links, get_chat_join_link, get_poster
...
async def start(client, message):
    ...
    if len(message.command) != 2:
        buttons = [
            [InlineKeyboardButton('🎬 Browse Movies', callback_data='bm_main'),
             InlineKeyboardButton('🎭 Actor Search', callback_data='actor_menu')],
            ...
            [InlineKeyboardButton('🆕 Latest Releases', callback_data='bm_new')],
            [InlineKeyboardButton(f'📢 Updates', url='https://t.me/movie_ottupdates'),
             InlineKeyboardButton(f'📣 Channel', url='https://t.me/mn_movies2')],
            ...
            [InlineKeyboardButton('🔗 Source', url='https://github.com/mn-bots/ShobanaFilterBot')],
        ]
        reply_markup = InlineKeyboardMarkup(buttons)
